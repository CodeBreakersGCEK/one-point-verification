...
<div className='h-full ' >
    <form onSubmit={onSubmit} className='flex items-center h-full justify-center text-sky-900' >
    ...
    <div className={field}>
            <label><Image src='/images/aadhar.png' width={65} height={30} /></label>
            <input
              type="text"
              name="aadhar"
          ...
          <div className={field}>
            <label><Image src='/images/pan.png' width={65} height={30} /> </label>
            <input
              type="text"
              name="pan"
          ...
          <div className={field}>
            <label><Image src='/images/bank.png' width={65} height={30} /></label>
            <input
              type="text"
              name="account"
          ...
          <button className=" text-center bg-sky-900 text-white text-lg  font-normal leading-6 rounded-3xl   px-14 py-1 md:py-2 mt-5 scale-100 hover:scale-105 transition-transform   duration-300 ease-linear">Verify</button>
          </div>
    </form>
</div>
    </Layout>
